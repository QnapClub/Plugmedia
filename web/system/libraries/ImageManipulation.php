...
/**
 *  PART OF CodeIgniter (modified to be use in Plugmedia package)
 *
 ...
 */
define('DIR_WRITE_MODE',octdec('0777'));
class CORE_ImageManipulation {
	 ...
	 * @return	void
	 */
	function CORE_ImageManipulation($props = array())
	{
	...
	function setConfig($props = array())
	{
		if (count($props) > 0)
		{
