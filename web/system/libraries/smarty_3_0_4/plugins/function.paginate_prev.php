...
function smarty_function_paginate_prev($params, &$smarty) {
    ...
    return $_show ? '<a href="' . str_replace('&','&amp;', $_url) . '"' . $_attrs . ' class="prev custom_target"><span>' . $_text . '</span></a>' : '<a href="javascript:void(0)"' . $_attrs . ' class="prev disabled"><span>' . $_text . '</span></a><span class="space"></span>';
}
