...
function smarty_function_paginate_next($params, &$smarty) {
    ...
    return $_show ? '<a href="' . str_replace('&','&amp;', $_url) . '"' . $_attrs . ' class="next custom_target"><span>' . $_text . '</span></a>' : '<span class="space"></span><a href="javascript:void(0)"' . $_attrs . ' class="next disabled"><span>' . $_text . '</span></a>';
}
