...
class getid3_id3v2
{
	...
	//        Flags         $xx xx
		...
		if (array_key_exists('exthead', $thisfile_id3v2 ) && array_key_exists('length', $thisfile_id3v2['exthead'] )) {
			$sizeofframes -= ($thisfile_id3v2['exthead']['length'] + 4);
		}
		if (array_key_exists('isfooter', $thisfile_id3v2_flags)) {
	...
	//        ID3v2 size             4 * %0xxxxxxx
		...
		if (array_key_exists ('recorging_time',$thisfile_id3v2['comments']))
		{
