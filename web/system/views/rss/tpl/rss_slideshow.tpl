...
<img src="../../../../api.php?ac=rotatePic&amp;pic={$media.file_id}&amp;percent=1" tn="../../../../{$media.thumbnail}" title="" caption="" link="http://{$PM_LOCATION}/display.php?dir={$current_dir.link_dir}&amp;file={$media.file_id}&amp;ref={$smarty.get.ref}" target="_blank" pause="" vidpreview="" />
